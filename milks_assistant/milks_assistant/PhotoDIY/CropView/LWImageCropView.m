...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _cropOk = [[UIButton alloc] initWithFrame:CGRectMake(frame.size.width - 55, frame.size.height - 55, 40, 40)];
        _cropCancel = [[UIButton alloc] initWithFrame:CGRectMake(15, frame.size.height - 55, 40, 40)];
        [self addSubview:_cropOk];
        [self addSubview:_cropCancel];
        ...
        [_cropOk addTarget:self action:@selector(cropOkAction:) forControlEvents:UIControlEventTouchUpInside];
        [_cropCancel addTarget:self action:@selector(cropCancelAction:) forControlEvents:UIControlEventTouchUpInside];
